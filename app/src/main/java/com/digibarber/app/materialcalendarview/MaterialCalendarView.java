package com.digibarber.app.materialcalendarview;
...
import com.digibarber.app.materialcalendarview.format.ArrayWeekDayFormatter;
import com.digibarber.app.materialcalendarview.format.DateFormatTitleFormatter;
import com.digibarber.app.materialcalendarview.format.DayFormatter;
import com.digibarber.app.materialcalendarview.format.MonthArrayTitleFormatter;
import com.digibarber.app.materialcalendarview.format.TitleFormatter;
import com.digibarber.app.materialcalendarview.format.WeekDayFormatter;
...
public class MaterialCalendarView extends ViewGroup {
    ...
    private final com.digibarber.app.materialcalendarview.TitleChanger titleChanger;

    private final TextView title;
    private final com.digibarber.app.materialcalendarview.DirectionButton buttonPast;
    private final com.digibarber.app.materialcalendarview.DirectionButton buttonFuture;
    private final com.digibarber.app.materialcalendarview.CalendarPager pager;
    ...
    public MaterialCalendarView(Context context, AttributeSet attrs) {
        ...
        buttonPast = new com.digibarber.app.materialcalendarview.DirectionButton(getContext());
        buttonPast.setContentDescription(getContext().getString(R.string.previous));
        title = new TextView(getContext());
        buttonFuture = new com.digibarber.app.materialcalendarview.DirectionButton(getContext());
        buttonFuture.setContentDescription(getContext().getString(R.string.next));
        pager = new com.digibarber.app.materialcalendarview.CalendarPager(getContext());

        buttonPast.setOnClickListener(onClickListener);
        buttonFuture.setOnClickListener(onClickListener);

        titleChanger = new com.digibarber.app.materialcalendarview.TitleChanger(title);
        ...
        if (isInEditMode()) {
            removeView(pager);
            com.digibarber.app.materialcalendarview.MonthView monthView = new com.digibarber.app.materialcalendarview.MonthView(this, currentMonth, getFirstDayOfWeek());
    ...
    /**
     * Set a {@linkplain com.digibarber.app.materialcalendarview.format.WeekDayFormatter}
     * with the provided week day labels
     *
     * @param weekDayLabels Labels to use for the days of the week
     * @see com.digibarber.app.materialcalendarview.format.ArrayWeekDayFormatter
     * @see #setWeekDayFormatter(com.digibarber.app.materialcalendarview.format.WeekDayFormatter)
     */
    ...
    /**
     * Set a {@linkplain com.digibarber.app.materialcalendarview.format.TitleFormatter}
     * using the provided month labels
     *
     * @param monthLabels month labels to use
     * @see com.digibarber.app.materialcalendarview.format.MonthArrayTitleFormatter
     * @see #setTitleFormatter(com.digibarber.app.materialcalendarview.format.TitleFormatter)
     */
     ...
     *
     * @param orientation {@link com.digibarber.app.materialcalendarview.MaterialCalendarView#VERTICAL} or {@link com.digibarber.app.materialcalendarview.MaterialCalendarView#HORIZONTAL}
     */
     ...
     *
     * @return Title animation orientation {@link com.digibarber.app.materialcalendarview.MaterialCalendarView#VERTICAL} or {@link com.digibarber.app.materialcalendarview.MaterialCalendarView#HORIZONTAL}
     */
    ...
    protected void dispatchOnDateSelected(final CalendarDay day, final boolean selected) {
        ...
        if (l != null) {
            l.onDateSelected(com.digibarber.app.materialcalendarview.MaterialCalendarView.this, day, selected);
        }
    }
    ...
    protected void dispatchOnRangeSelected(final CalendarDay firstDay, final CalendarDay lastDay) {
        ...
        if (listener != null) {
            listener.onRangeSelected(com.digibarber.app.materialcalendarview.MaterialCalendarView.this, days);
        }
    }
    ...
    protected void dispatchOnMonthChanged(final CalendarDay day) {
        ...
        if (l != null) {
            l.onMonthChanged(com.digibarber.app.materialcalendarview.MaterialCalendarView.this, day);
        }
    }

    /**
     * Call by {@link com.digibarber.app.materialcalendarview.CalendarPagerView} to indicate that a day was clicked and we should handle it.
     ...
     * @param dayView
     */
    protected void onDateClicked(final com.digibarber.app.materialcalendarview.DayView dayView) {
    ...
    public void onInitializeAccessibilityEvent(@NonNull AccessibilityEvent event) {
        ...
        event.setClassName(com.digibarber.app.materialcalendarview.MaterialCalendarView.class.getName());
    }

    @Override
    public void onInitializeAccessibilityNodeInfo(@NonNull AccessibilityNodeInfo info) {
        super.onInitializeAccessibilityNodeInfo(info);
        info.setClassName(com.digibarber.app.materialcalendarview.MaterialCalendarView.class.getName());
    }
    ...
    public class StateBuilder {
        ...
        public void commit() {
            com.digibarber.app.materialcalendarview.MaterialCalendarView.this.commit(new State(this));
        }
    }
    ...
    private void commit(State state) {
        ...
        switch (calendarMode) {
            case MONTHS:
                newAdapter = new com.digibarber.app.materialcalendarview.MonthPagerAdapter(this);
                break;
            case WEEKS:
