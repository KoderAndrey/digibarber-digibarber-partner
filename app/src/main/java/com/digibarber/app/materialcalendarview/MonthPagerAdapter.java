 ...
 */
class MonthPagerAdapter extends CalendarPagerAdapter<com.digibarber.app.materialcalendarview.MonthView> {
    ...
    @Override
    protected com.digibarber.app.materialcalendarview.MonthView createView(int position) {
        return new com.digibarber.app.materialcalendarview.MonthView(mcv, getItem(position), mcv.getFirstDayOfWeek());
    }

    @Override
    protected int indexOf(com.digibarber.app.materialcalendarview.MonthView view) {
    ...
    protected boolean isInstanceOfView(Object object) {
        return object instanceof com.digibarber.app.materialcalendarview.MonthView;
    }
