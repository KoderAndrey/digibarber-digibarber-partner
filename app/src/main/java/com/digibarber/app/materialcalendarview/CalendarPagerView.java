...
import com.digibarber.app.materialcalendarview.MaterialCalendarView.ShowOtherDates;
...
import static com.digibarber.app.materialcalendarview.MaterialCalendarView.SHOW_DEFAULTS;
import static com.digibarber.app.materialcalendarview.MaterialCalendarView.showOtherMonths;
...
abstract class CalendarPagerView extends ViewGroup implements View.OnClickListener {
    ...
    private final ArrayList<com.digibarber.app.materialcalendarview.DecoratorResult> decoratorResults = new ArrayList<>();
    @ShowOtherDates
    ...
    private final Collection<com.digibarber.app.materialcalendarview.DayView> dayViews = new ArrayList<>();
    ...
    protected void addDayView(Collection<com.digibarber.app.materialcalendarview.DayView> dayViews, Calendar calendar) {
        CalendarDay day = CalendarDay.from(calendar);
        com.digibarber.app.materialcalendarview.DayView dayView = new com.digibarber.app.materialcalendarview.DayView(getContext(), day);
        dayView.setOnClickListener(this);
        dayView. setTextSize(300);
    ...
    protected abstract void buildDayViews(Collection<com.digibarber.app.materialcalendarview.DayView> dayViews, Calendar calendar);

    protected abstract boolean isDayEnabled(CalendarDay day);

    void setDayViewDecorators(List<com.digibarber.app.materialcalendarview.DecoratorResult> results) {
    ...
    public void setDateTextAppearance(int taId) {
        for (com.digibarber.app.materialcalendarview.DayView dayView : dayViews) {
    ...
    protected void invalidateDecorators() {
        ...
        for (com.digibarber.app.materialcalendarview.DayView dayView : dayViews) {
            ...
            for (com.digibarber.app.materialcalendarview.DecoratorResult result : decoratorResults) {
    ...
    public void onClick(View v) {
        if (v instanceof com.digibarber.app.materialcalendarview.DayView) {
            final com.digibarber.app.materialcalendarview.DayView dayView = (com.digibarber.app.materialcalendarview.DayView) v;
    ...
    public void onInitializeAccessibilityEvent(@NonNull AccessibilityEvent event) {
        ...
        event.setClassName(com.digibarber.app.materialcalendarview.CalendarPagerView.class.getName());
    }

    @Override
    public void onInitializeAccessibilityNodeInfo(@NonNull AccessibilityNodeInfo info) {
        super.onInitializeAccessibilityNodeInfo(info);
        info.setClassName(com.digibarber.app.materialcalendarview.CalendarPagerView.class.getName());
    }
