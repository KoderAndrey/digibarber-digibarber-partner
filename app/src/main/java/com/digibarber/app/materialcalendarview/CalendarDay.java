...
public final class CalendarDay implements Parcelable {
     ...
     */
    @NonNull
    public static com.digibarber.app.materialcalendarview.CalendarDay from(int year, int month, int day) {
        return new com.digibarber.app.materialcalendarview.CalendarDay(year, month, day);
    }
     ...
     * @return CalendarDay set to the specified date
     */
    public static com.digibarber.app.materialcalendarview.CalendarDay from(@Nullable Calendar calendar) {
        if (calendar == null) {
            return null;
        }
        return from(
     ...
     * @return CalendarDay set to the specified date
     */
    public static com.digibarber.app.materialcalendarview.CalendarDay from(@Nullable Date date) {
        if (date == null) {
            return null;
        }
     ...
     *
     * @see com.digibarber.app.materialcalendarview.CalendarDay#today()
     */
    @Deprecated
    public CalendarDay() {
     ...
     * @see com.digibarber.app.materialcalendarview.CalendarDay#from(Calendar)
     */
    @Deprecated
     ...
     * @see com.digibarber.app.materialcalendarview.CalendarDay#from(Date)
     */
    @Deprecated
     ...
     */
    public boolean isInRange(@Nullable com.digibarber.app.materialcalendarview.CalendarDay minDate, @Nullable com.digibarber.app.materialcalendarview.CalendarDay maxDate) {
     ...
     */
    public boolean isBefore(@NonNull com.digibarber.app.materialcalendarview.CalendarDay other) {
        if (other == null) {
     ...
     */
    public boolean isAfter(@NonNull com.digibarber.app.materialcalendarview.CalendarDay other) {
        if (other == null) {
            throw new IllegalArgumentException("other cannot be null");
        }
    ...
    public boolean equals(Object o) {
        ...
        com.digibarber.app.materialcalendarview.CalendarDay that = (com.digibarber.app.materialcalendarview.CalendarDay) o;
    ...
    public static final Creator<com.digibarber.app.materialcalendarview.CalendarDay> CREATOR = new Creator<com.digibarber.app.materialcalendarview.CalendarDay>() {
        public com.digibarber.app.materialcalendarview.CalendarDay createFromParcel(Parcel in) {
            return new com.digibarber.app.materialcalendarview.CalendarDay(in);
        }

        public com.digibarber.app.materialcalendarview.CalendarDay[] newArray(int size) {
            return new com.digibarber.app.materialcalendarview.CalendarDay[size];
        }
    };
}
