...
import com.digibarber.app.materialcalendarview.CalendarUtils;
...
public interface WeekDayFormatter {
     ...
     */
    public static final com.digibarber.app.materialcalendarview.format.WeekDayFormatter DEFAULT = new CalendarWeekDayFormatter(CalendarUtils.getInstance());
}
